...
<script>
	...
	req += "command=find_playlist_by_id&playlist_id=928432058001&playlist_fields=id,name,shortDescription,thumbnailURL,length&token=" + encodeURIComponent(token);  // tokens need to be URL-encoded
