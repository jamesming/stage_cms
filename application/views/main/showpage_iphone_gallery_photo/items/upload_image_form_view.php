	...
	<div id='input_container'    >
			<div  class='first float_left' >
				...
				echo '0';
				    ...
				    ?>">
				<input name="what_item" type="hidden" value="showpage_iphone_gallery_photo">
				<input name="showpage_iphone_gallery_photo_item_id" id="showpage_iphone_gallery_photo_item_id" type="hidden" value="<?php echo $data['showpage_iphone_gallery_photo_item_id']    ?>">
