...
function open_dialogue_upload_image( nu_spotlight_items_image_id, image_type, image_type_id ){
		...
		.attr('src','<?php echo base_url();    ?>index.php/main/upload_image_form?nu_spotlight_item_id=<?php echo $data['nu_spotlight_items'][0]['id']    ?>&nu_spotlight_items_image_id=' + nu_spotlight_items_image_id +'&image_type='+image_type +'&image_type_id='+image_type_id);
