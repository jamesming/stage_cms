...
form#image_nu_spotlight_item_form input{
padding:6px 5px;
width:490px;	
}
...
<form id='image_nu_spotlight_item_form'>
		<table  id='main'>
			<tr>
				...
				<td  class='main_table '><input name="name" id="" type="" value="<?php echo $data['nu_spotlight_items'][0]['name']    ?>">
				</td>
			</tr>
			<tr>
				<td  class='main_table '> Title
				</td>
				<td  class='main_table '><input name="title" id="" type="" value="<?php echo $data['nu_spotlight_items'][0]['title']    ?>">
				</td>
			</tr>
			...
			<tr>
				<td class='main_table image_assets' colspan=2>
					<div  class=' image_assets' >
							<div image_type='feature' class='float_left image_div'  id='image_nu_spotlight_item_feature' nu_spotlight_items_image_id='<?php  	echo $data['nu_spotlight_items'][0]['feature_nu_spotlight_items_image_id'] ?>'>
							</div>
							
							<div  image_type='thumb' class='float_left image_div'   id='image_nu_spotlight_item_thumb'  nu_spotlight_items_image_id='<?php  	echo $data['nu_spotlight_items'][0]['thumb_nu_spotlight_items_image_id'] ?>'>
...
function open_dialogue_upload_image( nu_spotlight_items_image_id, image_type ){
		...
		.attr('src','<?php echo base_url();    ?>index.php/main/upload_image_form?nu_spotlight_item_id=<?php echo $data['nu_spotlight_items'][0]['id']    ?>&nu_spotlight_items_image_id=' + nu_spotlight_items_image_id +'&image_type='+image_type);
	...
	$(document).ready(function() {
				...
				$('#submit').click(function(event) {
					...
					$.post("<?php echo base_url(). 'index.php/main/ajax_update';    ?>",{
						...
						nu_spotlight_item_id:'<?php echo $data['nu_spotlight_items'][0]['id']    ?>'
						},function(xml) {
