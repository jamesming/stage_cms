...
<script type="text/javascript" language="Javascript">
	...
	$(document).ready(function() {
			...
			<?php if( count($data['nu_spotlight_videos_calendars'])  ){?>
				...
				$('#text_area').html('<?php  echo $data['nu_spotlight_videos_calendars'][0]->blurb   ?>');
				
			<?php } ?>
		
		
			$('#line_up').click(function(event) {
						document.location = '<?php  echo base_url()   ?>index.php/main/line_up_form?nu_spotlight_videos_calendar_id=<?php echo $data['nu_spotlight_videos_calendar_id']    ?>&nu_spotlight_set_id=<?php  echo $data['nu_spotlight_set_id']   ?>&month=<?php  echo $data['month']   ?>&day=<?php  echo $data['day']   ?>&year=<?php  echo $data['year']   ?>';
			});	
