...
<form id='uploadForm' 
	...
	<div id='input_container'    >
			<div  class='first float_left' >
				...
				if( isset($data['showpage_episodes_items_image_id'])){
				echo $data['showpage_episodes_items_image_id'];
				}else{
				echo '0';
				};
				
				    ?>">
				<input name="what_item" type="hidden" value="showpage_episodes">
				<input name="showpage_episodes_item_id" id="showpage_episodes_item_id" type="hidden" value="<?php echo $data['showpage_episodes_item_id']    ?>">
