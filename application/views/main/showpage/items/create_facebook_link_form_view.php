...
<script type="text/javascript" language="Javascript">
	...
	$(document).ready(function() {
							...
							jQuery('#cropbox').Jcrop({		
								...
								aspectRatio: 0,
//								setSelect:   [<?php echo $data['showpage_items_images'][0]->facebook_top   ?>,  <?php echo $data['showpage_items_images'][0]->facebook_left   ?> ,<?php echo $data['showpage_items_images'][0]->facebook_width   ?>, <?php echo $data['showpage_items_images'][0]->facebook_height   ?>]
								setSelect:   [<?php echo $data['showpage_items_images'][0]->facebook_left   ?>,<?php echo $data['showpage_items_images'][0]->facebook_top   ?>,<?php echo $data['showpage_items_images'][0]->facebook_left + $data['showpage_items_images'][0]->facebook_width   ?>,<?php echo $data['showpage_items_images'][0]->facebook_top + $data['showpage_items_images'][0]->facebook_height   ?>]
