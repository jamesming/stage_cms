...
<form id='uploadForm' 
	...
	<div id='input_container'    >
			<div  class='first float_left' >
				...
				if( isset($data['event_items_image_id'])){
				echo $data['event_items_image_id'];
				}else{
				echo '0';
				};
				
				    ?>">
				<input name="what_item" type="hidden" value="event">
				<input name="event_item_id" id="event_item_id" type="hidden" value="<?php echo $data['event_item_id']    ?>">
