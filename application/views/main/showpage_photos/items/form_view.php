...
<head>
	...
	$(document).ready(function() { 
		...
		$('#submit').click(function(event) {
						...
						$.post("<?php echo base_url(). 'index.php/main/ajax_update';    ?>",{
							...
							id:<?php echo (isset($data['showpage_photos_items'][0]['id'])?$data['showpage_photos_items'][0]['id']:'0');    ?>,
							crud:'update',
							set_what_array:$('#name').serialize()
							},function(xml) {
			...
			window.onload = function() {
				var settings = {
					...
					upload_url: "<?php echo  base_url();   ?>index.php/home/upload_photos_success?showpage_item_id=<?php echo (isset($data['showpage_photos_items'][0]['showpage_item_id'])?$data['showpage_photos_items'][0]['showpage_item_id']:'0');    ?>&showpage_photos_item_id=<?php echo (isset($data['showpage_photos_items'][0]['id'])?$data['showpage_photos_items'][0]['id']:'0');    ?>",
	...
	function queueComplete(){
							...
							showpage_item_id:<?php echo (isset($data['showpage_photos_items'][0]['showpage_item_id'])?$data['showpage_photos_items'][0]['showpage_item_id']:'0');    ?>,
							showpage_photos_item_id:<?php echo (isset($data['showpage_photos_items'][0]['id'])?$data['showpage_photos_items'][0]['id']:'0');    ?>
							},function(data) {
										$('#error_div').html(data);
