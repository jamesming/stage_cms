...
.video_title_bar{
    background-image: url("assets/images/VIDEO-TITLE_bar.png");
...
.video_title_bar .title-text{
	float:left;	
	width: 900px;
}
.video_title_bar .scroll-button{
	height:22px;
	float:left;
	width:18px;
	cursor:pointer;
}
.video_title_bar .scroll-button.left{
	margin-right: 9px;
}
.video_title_bar .scroll-button.right{
}
.video_scroller li{
cursor:pointer;	
margin-right:20px;
...
.video_scroller li .img-div img{
width:150px;
}

.video_scroller li .text-div{
width:135px;
font-size:10px;
font-weight:bold;
float:left;
...
.video_scroller li  .text-div .video-name{
padding-left:11px;
height:53px;
}

.video_scroller li  .text-div .watch-now{
background-image: url("assets/images/VIDEO-watch-now-GRAY.png");
background-position: center center;
background-repeat: no-repeat;
height:33px;
width: 150px;
...
.red-area-container .red-column .red-title{
    background-image: url("assets/images/Video_title_tab.png");
    background-position: center center;
    background-repeat: no-repeat;	
    padding-top: 19px;    	
    padding-left: 16px;
...
.red-area-container .red-column li .img-div{
width:150px;
float:left;
}
...
background-image: url("assets/images/VIDEO-watch-now-RED.png");
background-position: center center;
background-repeat: no-repeat;
height:33px;
width: 150px;
